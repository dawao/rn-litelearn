...
@connect(({ app }) => ({ ...app }))
class TextbookSelect extends Component {
  ...
  goBack = () => {
    this.props.dispatch(NavigationActions.back({ routeName: 'PreTest' }))
  }
